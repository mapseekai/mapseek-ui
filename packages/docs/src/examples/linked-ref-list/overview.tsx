...
export type LinkedRefListDemoLabels = {
  readonly openLabel: string
  readonly groups: LinkedRefGroup[]
}
...
} satisfies LinkedRefListDemoLabels
...
export function LinkedRefListDemo({ labels }: { readonly labels: LinkedRefListDemoLabels }) {
  return (
    <div data-demo="linked-ref-list" className="border border-border bg-background p-3">
      <LinkedRefList groups={labels.groups} kindIcons={kindIcons} openLabel={labels.openLabel} />
    </div>
  )
}
