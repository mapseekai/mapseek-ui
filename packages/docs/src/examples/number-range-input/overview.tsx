...
export type NumberRangeInputDemoLabels = {
  readonly intro: string
  readonly reset: string
}

export const zhNumberRangeInputLabels = {
  intro: "数字输入和单滑块组合。支持直接输入、键盘步进、min/max 限制和小数 step。",
  reset: "清空",
} satisfies NumberRangeInputDemoLabels

export const enNumberRangeInputLabels = {
  intro:
    "Number input paired with a single slider. Supports typing, keyboard steps, min/max, and decimal steps.",
  reset: "Clear",
} satisfies NumberRangeInputDemoLabels

export function NumberRangeInputDemo({ labels }: { readonly labels: NumberRangeInputDemoLabels }) {
  ...
  return (
    <div data-demo="number-range-input" className="flex w-full max-w-[560px] flex-col gap-4">
