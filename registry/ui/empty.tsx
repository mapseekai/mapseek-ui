...
function Empty({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="empty"
      className={cn(
        "flex min-w-0 flex-1 flex-col items-center justify-center gap-4 rounded-none bg-background p-6 text-center text-balance",
        className,
      )}
      {...props}
    />
...
function EmptyTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("text-body-md-strong text-foreground", className)}
      {...props}
    />
  )
}
...
function EmptyDescription({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("text-body-sm leading-normal text-muted-foreground", className)}
      {...props}
    />
  )
}
